...
### New component `<sdds-inline-tabs>` with child `<sdds-inline-tab>`
### New component `<sdds-folder-tabs>` with child `<sdds-folder-tab>`
...
Both of these new version of the component comes with their own child element to
represent each tab. The content that is displayed under each tab, is not longer handled
by the component. And is therefor something that you as a user of the components will 
have to implement yourself. We will of course be peresenting examples of how this could
be implemented, and if you have any questions we are always here to help.
...
```jsx
// New sdds-inline-tabs
<sdds-inline-tabs>
  <sdds-inline-tab label="Tab one"></sdds-inline-tab>
  <sdds-inline-tab label="Tab two" selected></sdds-inline-tab>
  <sdds-inline-tab disabled label="Tab three"></sdds-inline-tab>
</sdds-inline-tabs>

// New sdds-folder-tabs
<sdds-folder-tabs>
  <sdds-folder-tab label="First tab"></sdds-folder-tab>
  <sdds-folder-tab label="Second tab" selected></sdds-folder-tab>
  <sdds-folder-tab label="Third tab" disabled></sdds-folder-tab>
</sdds-folder-tabs>
```
