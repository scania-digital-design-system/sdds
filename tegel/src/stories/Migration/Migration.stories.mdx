...
#### Renamed property `paddingReset` to `equalPadding`.

Equal padding was deemed a more descriptive name.

##### What action is required?

Replace `padding-reset` with `equal-padding`.

```jsx
// Old ❌
<sdds-accordion>
  <sdds-accordion-item padding-reset>
    // ...
  </sdds-accordion-item>
</sdds-accordion>
...
// New ✅
<sdds-accordion>
  <sdds-accordion-item equal-padding>
    // ...
  </sdds-accordion-item>
</sdds-accordion>
```
