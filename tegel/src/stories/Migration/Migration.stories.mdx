...
## Inline Tabs & Folder Tabs

### Updated `<sdds-inline-tabs>` and introduced `<sdds-folder-tabs>` with
### child components `<sdds-tab-link>` & `<sdds-tab-button>`

Previously we had the `<sdds-inline-tabs>` and `<sdds-inline-tabs-fullbleed>`. These 
reminded little of eachother in appearence and therefor it made more sense to treat
...
Both of these tabs can function with either buttons or links, there for we have
introduced two new child components (`<sdds-tab-link>` & `<sdds-tab-button>`) that 
work with both the `<sdds-inline-tabs>` and  `<sdds-tab-button>`. The content that is
displayed under each tab, is not longer handled by the component. And is therefor
something that you as a user of the components will have to implement yourself. We 
will of course be peresenting examples of how this could be implemented, and if you 
...
<sdds-inline-tabs>
  <sdds-tab-button>First tab</sdds-tab-button>
  <sdds-tab-button>Second tab</sdds-tab-button>
  <sdds-tab-button selected>Third tab</sdds-tab-button>
  <sdds-tab-button disabled>Fourth tab</sdds-tab-button>
</sdds-inline-tabs>

// New sdds-inline-tabs with links 🆕
<sdds-inline-tabs>
  <sdds-tab-link link-href="#">First tab</sdds-tab-link>
  <sdds-tab-link link-href="#">Second tab</sdds-tab-link>
  <sdds-tab-link selected link-href="#">Third tab</sdds-tab-link>
  <sdds-tab-link disabled link-href="#">Fourth tab</sdds-tab-link>
</sdds-inline-tabs>
