...
| `modeVariant`    | `mode-variant`    | Set the variant of the the dropdown.                                                                               | `"primary" \| "secondary"`                               | `undefined`  |
| `openDirection`  | `open-direction`  | Direction that the dropdown will open. By default set to auto.                                                     | `"auto" \| "down" \| "up"`                               | `'auto'`     |
