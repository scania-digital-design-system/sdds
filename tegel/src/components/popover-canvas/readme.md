...
| `referenceEl`    | --                | Element that will trigger the popover (takes priority over selector) | `Element \| ({ getBoundingClientRect: () => ClientRect \| DOMRect; contextElement?: Element; })`                                                                                                             | `undefined` |
| `selector`       | `selector`        | The CSS-selector for an element that will trigger the popover        | `string`                                                                                                                                                                                                     | `''`        |
| `show`           | `show`            | Decides if the Popover Canvas should be visible from the start       | `boolean`                                                                                                                                                                                                    | `false`     |
