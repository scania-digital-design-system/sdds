...
import readmeButton from './header-button-alt/readme.md';
...
// <!--
// <sdds-header-launcher-v2 slot="end" variant="grid">
  ...
  <sdds-header-v2>
    ...
    <sdds-header-launcher-v2 slot="end">
      ...
      <sdds-header-launcher-list>
        <sdds-header-launcher-list-link>Button</sdds-header-launcher-list-link>
        <sdds-header-launcher-list-link>Button</sdds-header-launcher-list-link>
        <sdds-header-launcher-list-link>Button</sdds-header-launcher-list-link>
        <sdds-header-launcher-list-link>Button</sdds-header-launcher-list-link>
      </sdds-header-launcher-list>
