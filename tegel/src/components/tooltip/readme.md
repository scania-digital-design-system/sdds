...
| `referenceEl`      | --                   | Element that will trigger the tooltip (takes priority over selector)                           | `Element \| ({ getBoundingClientRect: () => ClientRect \| DOMRect; contextElement?: Element; })`                                                                                                             | `undefined` |
