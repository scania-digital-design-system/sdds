...
| ---------- | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | --------------------- |
| `checked`  | `checked`   | Setting it to true set component state to checked. Valid only for chipType checkbox and radio.                                                                                                                                            | `boolean`                           | `false`               |
...
| `chipType` | `chip-type` | Type of chip, depends on usage                                                                                                                                                                                                            | `"button" \| "checkbox" \| "radio"` | `'button'`            |
| `name`     | `name`      | Name for the checkbox or radio input element. Also creates a reference between label and input. Valid only for chipType checkbox and radio.                                                                                               | `string`                            | `undefined`           |
| `size`     | `size`      | Size of the chip component                                                                                                                                                                                                                | `"lg" \| "sm"`                      | `'lg'`                |
| `value`    | `value`     | Value of input. Valid only for chipType checkbox and radio.                                                                                                                                                                               | `string`                            | `undefined`           |
