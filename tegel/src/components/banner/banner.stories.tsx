...
export default {
  ...
  argTypes: {
    ...
    header: {
      name: 'Header',
      description: 'Sets text to be displayed in header section.',
      control: {
        type: 'text',
      },
    },
    subheader: {
      name: 'Subheader',
      description: 'Sets text to be displayed in subheader section.',
      control: {
        type: 'text',
      },
    },
    link: {
      name: 'Link',
      description: 'Sets text to be displayed in link section.',
      control: {
        type: 'text',
      },
    },
