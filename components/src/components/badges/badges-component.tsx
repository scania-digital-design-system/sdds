...
watchValue(){
  ...
  else{this.value !== ""?console.warn("The provided value is either empty or string, please provide value as number."):""} 
}
componentWillLoad(){
  this.watchValue();
}
render() {  
    return (
      <div class={`sdds-badges sdds-badges-${this.size} sdds-badges-${this.shape}`}>
