...
| `enableMultiselect` | `enable-multiselect` | Enables multiselect feature of data-data-table                        | `boolean` | `false` |
| `noMinWidth`        | `no-min-width`       | Enables to customise width on data-table columns                      | `boolean` | `false` |
