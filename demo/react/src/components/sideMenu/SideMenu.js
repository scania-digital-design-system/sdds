...
function SideMenu() {
    ...
    return (
        <div
            className={`sdds-sidebar expanded ${collapse ? 'sdds-sidebar-collapse' : ''}`}>
            <div className={`sdds-navbar-side-menu expanded`}>
                <ul className="sdds-navbar-menu-list">
                    ...
                    <SideMenuDropdownItem itemName={'Dropdown 1'}
                                          collapse={collapse}
                                          itemList={[
                                              {name: 'Sub-item 1'},
                                              {name: 'Sub-item 2'},
                    ...
                    />
                    <SideMenuDropdownItem itemName={'Dropdown 2'} collapse={collapse}
                                          itemList={[
                                              {name: 'Sub-item 1'},
                                              {name: 'Sub-item 2'},
                                              {name: 'Sub-item 3'},
                ...
                <div className="sdds-navbar-menu-item sdds-navbar-menu-item-bottom sdds-navbar-menu-hide-on-mobile"
                    ...
                    <IconButton/>
                    <a className="sdds-navbar-menu-item-link">
                        Collapse
                    </a>
                </div>
            </div>
