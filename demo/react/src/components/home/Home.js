      ...
      <div className="section-wrapper sdds-col-xlg-8 sdds-col-md-4 sdds-col-sm-4">
        ...
        <div className="component-wrapper">
          ...
          <div className="sdds-banner sdds-banner-error">
            ...
            <span className="sdds-banner-prefix"><svg width="16" height="17" viewBox="0 0 16 17" fill="currentColor"
            ...
            <div className="sdds-banner-body">
              ...
              <a className="sdds-link sdds-banner-link" href="1">Link example</a>
            </div>
        ...
        <div className="component-wrapper">
          ...
          <div className="sdds-card ">
            ...
            <div className="sdds-card-body">This is a short and consist detail text describing for the user what this text
              is really about.</div>
        ...
        <div className="component-wrapper">
          ...
          This is an example of <a href="1">a link</a> inside a paragraph.
          This is an example of <a className="disabled" href="2">a link</a> inside a paragraph.
        </div>

        <div className="component-wrapper">
          <h5 className="sdds-headline-05">Modal</h5>
          <button id="modal" className="sdds-btn sdds-btn-primary">Open modal</button>
        ...
        <div className="component-wrapper">
          ...
          <div className="sdds-radio-button-group">
            ...
            <div className="sdds-radio-item">
              <input className="sdds-form-input" type="radio" name="rb-example-disabled" id="rb-option-3"
                  disabled />
          ...
          <div className="sdds-toast sdds-toast-error">
            ...
            <div className="sdds-toast-content">
              ...
              <div className="sdds-toast-body">
                ...
                <a className="sdds-toast-link" href="1">Link example</a>
              </div>
